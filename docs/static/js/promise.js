    ...
    constructor(executor) {
        ...
        let resolve = (value) => {
            if (this.status === PENDING) {
                ...
                this.value = value;
                this.resolveCallbacks.length && this.resolveCallbacks.forEach(fn => fn()); // 发布
            }
        };
        ...
        let reject = (reason) => {
            if (this.status === PENDING) {
                ...
                this.reason = reason;
                this.rejectCallbacks.length && this.rejectCallbacks.forEach(fn => fn()); // 发布
            }
        };
    ...
    then(onFulfilled, onRejected) {
        ...
        let promise2 = new _Promise((resolve, reject) => {
            ...
            if (this.status === FULFILLED) {
                // 保证 new 执行完, 可以拿到 promise2
                // onFulfilled onRejected 是异步的
                setTimeout(() => {
